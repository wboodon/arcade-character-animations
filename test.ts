...
game.onUpdate(function() {
    if (controller.up.isPressed() && !controller.down.isPressed())
        characterAnimations.setDirection(mySprite, characterAnimations.LookingDirection.Up)
    else if (!controller.up.isPressed() && controller.down.isPressed())
        characterAnimations.setDirection(mySprite, characterAnimations.LookingDirection.Down)
    else 
        characterAnimations.setDirection(mySprite, characterAnimations.LookingDirection.Forward)
})
...
characterAnimations.loopFrames(
    ...
    `],
    500,
    characterAnimations.rule(Predicate.LookingForward, Predicate.FacingRight, Predicate.NotMoving)
)
...
characterAnimations.loopFrames(
    ...
    `],
    500,
    characterAnimations.rule(Predicate.LookingUp, Predicate.FacingRight, Predicate.NotMoving)
)
...
characterAnimations.loopFrames(
    ...
    `],
    500,
    characterAnimations.rule(Predicate.LookingDown, Predicate.FacingRight, Predicate.NotMoving)
)
...
characterAnimations.loopFrames(
    ...
    `],
    500,
    characterAnimations.rule(Predicate.LookingForward, Predicate.FacingLeft, Predicate.NotMoving)
)
...
characterAnimations.loopFrames(
    ...
    `],
    500,
    characterAnimations.rule(Predicate.LookingUp, Predicate.FacingLeft, Predicate.NotMoving)
)
...
characterAnimations.loopFrames(
    ...
    `],
    500,
    characterAnimations.rule(Predicate.LookingDown, Predicate.FacingLeft, Predicate.NotMoving)
)